...
<div className='px-10 pt-10 '>
        ...
        <input className="text-txtborderColor font-poppins text-sm text-center overflow-hidden" 
            ...
            {imagePreview}
              ...
              <p className="text-red-400 text-center">
               {errors.coinimage?.type==="required" && "Coin image is Required"}
              </p>
        ...
        <div className='flex flex-row flex-wrap py-2'>
          <div className=' basis-full   md:basis-1/2 block md:inline-block'>
            ...
            <label className='text-txtborderColor pb-10 text-left text-md md:text-xl '>Coin Name</label>
            <div className="w-full">
            <input className="bg-bodygray w-full text-txtborderColor font-poppins border-2 border-txtborderColor py-1"
              ...
              <p className="text-red-400">
               {errors.coinname?.type==="required" && "Coin Name is Required"}
              </p>
               </div>
           </div>
           ...
           <div className='basis-full md:basis-1/2  block md:inline-block'>
            <label className='text-txtborderColor pb-10 text-left text-md md:text-xl '>Coin Symbol</label>
            <div>
            <input className="bg-bodygray w-full  text-txtborderColor font-poppins border-2 border-txtborderColor py-1"
              type="text"
            ...
            />
              <p className="text-red-400">
               {errors.coinsymbol?.type==="required" && "Coin symbol is Required"}
              </p>
            </div>
           </div>
        </div>
          ...
          <div className=' basis-full md:basis-4/6 text-txtborderColor  inline-block'>
          <div>
          <label className='text-txtborderColor pb-10 text-left text-md md:text-xl'>Chain/Network</label>
          </div>
            <div className='w-full md:pr-5'>
            <select  className="bg-bodygray w-full  font-poppins border-2  border-txtborderColor py-1" 
            {...register("networkchain", {required:true}) } >
          ...
          <div className='basis-full md:basis-2/6  inline-block'>
            <label className='text-txtborderColor  text-left text-md md:text-xl '>Launch Date</label>
            <div className='w-full'>
            <input className="bg-bodygray w-full  text-txtborderColor font-poppins border-2 border-txtborderColor py-1"
              type="date"
            ...
            />
              <p className="text-red-400">
               {errors.launchdate?.type==="required" && "Launch Date is Required"}
              </p>
            </div>
           </div>
            </div>
            ...
            <div className='flex flex-row flex-wrap py-2'>
            <div className='basis-full md:basis-1/6 text-txtborderColor  inline-block'>
          <div>
          <label className='text-txtborderColor pb-10 text-left text-md md:text-xl'>Listing Status</label>
          </div>
            <div className='w-full md:pr-5'>
            <select id="lstat" className="bg-bodygray w-full  font-poppins border-2  border-txtborderColor py-1" 
            {...register("listingstatus", {required:true}) } 
           >
           ...
           <div className='basis-full md:basis-5/6 inline-block'>
            <label className='text-txtborderColor pb-10 text-left text-md md:text-xl '>Contract Address</label>
            <div>
            <input id='cont' className="bg-bodygray w-full  text-txtborderColor font-poppins border-2 border-txtborderColor py-1"
              type="text"
              placeholder="Contract Address"
              {...register("contractaddress", {required:false, }) } 
            />
            <p className="text-red-400">
               {errors.contractaddress?.type==="pattern" && "Invalid site name"}
              </p>
            </div>
           </div>
        </div>
          ...
          <div className='basis-full md:basis-2/6 md:inline-block block'>
           ...
           <div className='basis-full md:basis-2/6 md:inline-block block'>
            <label className='text-txtborderColor pb-10 text-left text-md md:text-xl '>Chart Link</label>
            <div>
            <input className="bg-bodygray w-full text-txtborderColor  font-poppins border-2 border-txtborderColor py-1"
              type="text"
              placeholder="Chart Link"
              {...register("chartlink", {required:false}) } 
            />
            </div>
           </div>
        </div>
        ...
        <div className='flex flex-row flex-wrap py-2'>
          <div className='basis-full md:basis-2/6 md:inline-block block'>
            <label className='text-txtborderColor pb-10 text-left text-md md:text-xl'>Reddit Link</label>
            <div className='md:pr-5'>
            <input className="bg-bodygray w-full text-txtborderColor font-poppins border-2 border-txtborderColor py-1"
              type="text"
              placeholder="Reddit Link"
              {...register("redditlink", {required:false}) } 
            />
            </div>
           </div>
