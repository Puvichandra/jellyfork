...
async function handler(req,res) {
 ...
 if(req.method==='GET'){
    ...
    try {
        ...
        const documents = await db.collection('coinlist').find({activateCoin:true,activateCoin:"true"}, {projection:{"coinname":1, "marketcap":1, "price":1, "votes":1, "daysago":1, "ispromoted":1}} ).sort({"votes":-1,"coinname":-1}).toArray();
