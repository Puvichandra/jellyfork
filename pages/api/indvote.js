...
async function handler(req,res) {
    ...
    try {
        ...
        const promoteddocument = await db.collection('coinlist').find({ispromoted:true , ispromoted:"true"}, {projection:{"coinname":1, "marketcap":1, "price":1, "votes":1, "launchdate":1, "ispromoted":1,"networkchain":1}} ).sort({"votes":-1}).toArray();
